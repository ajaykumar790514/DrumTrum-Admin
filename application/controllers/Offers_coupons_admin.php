...
class Offers_coupons_admin extends CI_Controller {
                        ...
                        case 'save':
                            ...
                            if ($this->input->server('REQUEST_METHOD')=='POST') {
                                if ($id!=null) {
                                    ...
                                    if ($id=$this->offers_model->add_offer_coupon($data)) {
                                        logs($user->id,$id,'ADD','Offers');
                                        $return['res'] = 'success';
                                        $return['msg'] = 'Saved.';
                                    }
                                }
    ...
    public function change_offer_coupon_status()
    {
        ...
        logs($user->id,$id,'CHANGE_STATUS','Coupons And Offers');
    ...
    public function add_offer()
    {
        ...
        logs($user->id,$pid,'DELETE','Shops Coupon Offer');
        ...
        // {
            ...
            logs($user->id,$pid,'APPLY_OFFER_CAT','Shops Coupon Offer');
            $data['flg'] = '1';
            $data['oid'] = $oid;
            $data['value'] = $value;
    ...
    public function add_offer_cat()
    {
        ...
        if($check_offer)
        {
            ...
            foreach($data['get_products_by_category'] as $products)
            {
                ...
                logs($user->id,$pro,'DELETE','Shops Coupon Offer');
                $data['add_offer'] = $this->offers_model->add_data('shops_coupons_offers',$data);
                logs($user->id,$pro,'APPLY_OFFER_CAT','Shops Coupon Offer');
            }
    ...
    public function remove_offer_cat()
    {
        ...
        if ($this->offers_model->remove_offer_cat($oid,$parent_cat_id,$shop_id)) {
            logs($user->id,$parent_cat_id,'DELETE','Shops Coupon Offer');
            $this->load->view('admin/offers_coupons/offers/offer_action_cat',$data);
        } 
    }
    ...
    public function add_offer_var()
    {
        ...
        // {
            $data['add_offer'] = $this->offers_model->add_data('shops_coupons_offers',$data);
            logs($user->id,$pid,'APPLY_OFFER_VARIANT','Shops Coupon Offer');
            $data['flg'] = '1';
            $data['oid'] = $oid;
            $data['value'] = $value;
            $data['discount_type'] = $discount_type;
    ...
    public function add_offer_all_var()
    {
        ...
        // {
            ...
            $this->offers_model->delete_offer_products($deletedata);
            logs($user->id,$prod_id,'DELETE','Shops Coupon Offer');
            ...
            foreach($data['get_products_by_pro'] as $products)
            {
                ...
                {
                $data['add_offer'] = $this->offers_model->add_data('shops_coupons_offers',$data);
                logs($user->id,$pro,'APPLY_OFFER_VARIANT','Shops Coupon Offer');
                }
            }

    ...
    public function cash($action = null, $p1 = null, $p2 = null, $p3 = null, $p4 = null, $p5 = null, $p6 = null, $p7 = null,$p8=null)
    {
        ...
        switch ($action) {
            ...
            case 'tb':
                ...
                $config = array();
                $config["base_url"]         = base_url() . "cash-register/tb/" . $fromdate . "/" . $todate . "/" . $vendorId . "/" . $customerId . "/" . $getvendor . "/" . $getcustomer . "/" .$getaccounts;
                $this->load->model('cash_register_model');
    ...
    public function bank($action = null, $p1 = null, $p2 = null, $p3 = null, $p4 = null, $p5 = null, $p6 = null, $p7 = null,$p8=null)
    {
        ...
        switch ($action) {
            ...
            case 'tb':
                ...
                $this->load->library('pagination');
                $config = array();
                $config["base_url"]         = base_url() . "bank-register/tb/" . $fromdate . "/" . $todate . "/" . $vendorId . "/" . $customerId . "/" . $getvendor . "/" . $getcustomer. "/" .$getaccounts;
                $this->load->model('cash_register_model');
        ...
        switch ($action) {
            case null:
                ...
                case 'tb':
                    ...
                    $this->load->library('pagination');
                    $config = array();
                    $config["base_url"]         = base_url() . "expense/tb/" . $fromdate . "/" . $todate . "/" . $getvendor  . "/" .$getaccounts;
                    $this->load->model('cash_register_model');

          ...
          // discount
			...
			?>
                <tr>
                    ...
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif"><?= $row['product_name']; ?><?= $row['item_props_value']; ?></td>
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif"><?= $row['sku']; ?></td>

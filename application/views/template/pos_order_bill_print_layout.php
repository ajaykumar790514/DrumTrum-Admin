     ...
     <section class="main-page">
          ...
          <table class="table table-bordered items" >
              <tbody>
                ...
                $sr_n = 0;
                 foreach ($items as $key => $irow) : ?>
                <tr class="item-row item-row2">
                  <td><?=++$sr_n?></td>
                  <td><?=$irow->name?></td>
                  <td><?=$irow->sku?></td>
                  <td int nf qty2><?=$irow->qty?></td>
                  <td><?=$irow->unit_type?></td>
                  <td int nf free2><?=$irow->free?></td>
                  <td int nf list_price2><?=$irow->price_per_unit?></td>
                  ...
                  <?php if(@$is_igst==0): ?>
                  <td center><?=$irow->tax_value/2?> %</td>
                  <td int nf cgst2><?=$irow->tax/2?></td>
                  <td center><?=$irow->tax_value/2?> %</td>
                  <td int nf sgst2><?=$irow->tax/2?></td>
                  <?php else: ?>
                  <td center><?=$irow->tax_value?> %</td>
                  <td int nf igst2><?=$irow->tax?></td>
                  <?php endif; ?>
                  <td int nf amount2><?=$irow->total_price?></td>
                </tr>
                <?php endforeach; ?>
                <tr class="fill-row fill-row2">
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  <td colspan="3"><strong>Total : </strong> <span items_total><?=count($items)?></span> </td>
                  <td int nf total_qty2 style="width: auto;" >0</td>
                  <td colspan=""></td>
                  <td int nf total_free2>0</td>
                  <td int total_list_price2>0</td>
                  <td colspan="2"></td>
                  
                 <!--  <td int>1000</td>
                  <td int>500</td> -->
                  <?php if(@$row['is_igst']==0): ?>
                  <td int nf total_cgst2 colspan="2">0</td>
                  <td int nf total_sgst2 colspan="2">0</td>
                  <?php else: ?>
                  <td int total_igst2 colspan="2">0</td>
                  <?php endif; ?>
                  <td int nf total_amount2>0</td>
                </tr>
                    ...
                    <table class="table ">
                      <tbody>
                        <tr>
                          <td>Taxable Amount</td> 
                          <td> : </td>
                          <td int nf fixed f_taxable_amount2> 0  </td>
                        </tr>
                        <tr>
                          <td>Total Tax</td> 
                          <td> : </td>
                          <td int nf fixed f_total_tax2> 0  </td>
                        </tr>
                        <tr>
                          <td>Total Amount</td> 
                          <td> : </td>
                          <td int nf fixed f_total_amount2> 0  </td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
     ...
     <section class="main-page">
          ...
          <table class="table table-bordered items" >
              <tbody>
                ...
                $sr_n = 0;
                 foreach ($items as $key => $irow) : ?>
                <tr class="item-row item-row3">
                  <td><?=++$sr_n?></td>
                  <td><?=$irow->name?></td>
                  <td><?=$irow->sku?></td>
                  <td int nf qty3><?=$irow->qty?></td>
                  <td><?=$irow->unit_type?></td>
                  <td int nf free3><?=$irow->free?></td>
                  <td int nf list_price3><?=$irow->price_per_unit?></td>
                  ...
                  <?php if(@$is_igst==0): ?>
                  <td center><?=$irow->tax_value/2?> %</td>
                  <td int nf cgst3><?=$irow->tax/2?></td>
                  <td center><?=$irow->tax_value/2?> %</td>
                  <td int nf sgst3><?=$irow->tax/2?></td>
                  <?php else: ?>
                  <td center><?=$irow->tax_value?> %</td>
                  <td int nf igst3><?=$irow->tax?></td>
                  <?php endif; ?>
                  <td int nf amount3><?=$irow->total_price?></td>
                </tr>
                <?php endforeach; ?>
                <tr class="fill-row fill-row3">
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  <td colspan="3"><strong>Total : </strong> <span items_total><?=count($items)?></span> </td>
                  <td int nf total_qty3 style="width: auto;" >0</td>
                  <td colspan=""></td>
                  <td int nf total_free3>0</td>
                  <td int total_list_price3>0</td>
                  <td colspan="2"></td>
                  
                 <!--  <td int>1000</td>
                  <td int>500</td> -->
                  <?php if(@$row['is_igst']==0): ?>
                  <td int nf total_cgst3 colspan="2">0</td>
                  <td int nf total_sgst3 colspan="2">0</td>
                  <?php else: ?>
                  <td int total_igst3 colspan="2">0</td>
                  <?php endif; ?>
                  <td int nf total_amount3>0</td>
                </tr>
                    ...
                    <table class="table ">
                      <tbody>
                        <tr>
                          <td>Taxable Amount</td> 
                          <td> : </td>
                          <td int nf fixed f_taxable_amount3> 0  </td>
                        </tr>
                        <tr>
                          <td>Total Tax</td> 
                          <td> : </td>
                          <td int nf fixed f_total_tax3> 0  </td>
                        </tr>
                        <tr>
                          <td>Total Amount</td> 
                          <td> : </td>
                          <td int nf fixed f_total_amount3> 0  </td>
                        </tr>
                      </tbody>
                    </table>
                  </td>

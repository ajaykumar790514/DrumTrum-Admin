    ...
    $(document).ready(function() {
        ...
        $(function() {
            ...
            <?php if ($this->session->tempdata('success')) { ?>
                ...
                toastr.success('<?php echo $this->session->tempdata('success'); ?>')
            <?php }
            if ($this->session->tempdata('error')) { ?>

                toastr.error('<?php echo $this->session->tempdata('error'); ?>')
            <?php } ?>
...
<body class="fix-header fix-sidebar card-no-border logo-center">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
         <?php if(@$uri !='shop-pos'):?>
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light" style="max-width:100% !important; padding-left:10px;border-bottom:2px solid white">
                <!-- ============================================================== -->
                <!-- Logo -->
                <!-- ============================================================== -->
                <div class="navbar-header" style="width:100% !important;">
                  
                    <a class="navbar-brand text-white" href="<?php echo base_url('shop-dashboard');?>">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        <!-- This is  -->
                        <a class="navbar-brand text-white" data-toggle="modal" data-target="#sidebarModal">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <?php
                            $newOrders = $this->orders_model->getNewOrdersCancelRows(array('conditions'=>array('status'=>'6')));
                            if($newOrders!==FALSE){
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox scale-up">
                                <ul>
                                        ...
                                        <div class="message-center" id="messageCenter">
                                            <?php
                                                ...
                                                if($newOrders!==FALSE){
                                                    ...
                                                    $_SESSION['orders_notification_cancel_last_id'] = 0;
                                                }
                                            ?>
                                        </div>
                                        <script>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="<?php echo base_url('orders/set_session'); ?>"> <strong>Check all Orders</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="notificationIcon"> <i class="mdi mdi-message"></i>
                            <?php
                            $newOrders = $this->orders_model->getNewOrdersReturnRows(array('conditions'=>array('status'=>'7')));
                            if($newOrders!==FALSE){
                                echo '<div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>';
                            }
                            ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox scale-up">
                                <ul>
                                        ...
                                        <div class="message-center" id="messageCenter">
                                            <?php
                                                ...
                                                if($newOrders!==FALSE){
                                                    ...
                                                    $_SESSION['orders_notification_return_last_id'] = 0;
                                                }
                                            ?>
                                        </div>
                                        <script>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="<?php echo base_url('orders/set_session_return'); ?>">> <strong>Check all Orders</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo IMGS_URL.$shop_photo;?>" alt="user" class="profile-pic" /></a>
    ...
    $('ul.dropdown-menu [data-toggle="dropdown"]').on('click', function(event) {
        ...
        <!-- Sidebar Modal -->
        <div class="modal left fade" id="sidebarModal" tabindex="-1" role="dialog" aria-labelledby="sidebarModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-white" id="sidebarModalLabel">Menu</h4>
            ...
            <div class="modal-body">
                <ul class="list-group">
                    ...
                    <?php foreach($shop_menus as $menu): ?>
                        <?php
                        $rs = $this->admin_model->get_submenu_data($menu->id, $roleid);
                        $menu_flag = '0';
                        foreach($rs as $all) {
                        ...
                        ?>
                        <?php if($menu_flag > 0) { ?>
                            <li class="list-group-item" style="margin-left:-47px">
                                <a href="#submenu<?= $menu->id; ?>" class="nav-link" data-toggle="collapse" aria-expanded="false" aria-controls="submenu<?= $menu->id; ?>">
                                ...
                                <div class="collapse" id="submenu<?= $menu->id; ?>">
                                    <ul class="list-group">
                                        <?php foreach($rs as $r):
                                            ...
                                            if($submenucount == 0) { ?>
                                                <li class="list-group-item" style="margin-left:70px">
                                                    <a href="<?= base_url($r->url . '/' . $r->id); ?>">
                                                    <i class="fas fa-chevron-right "></i> <?= $r->title ?>
                                                    </a>
                                                </li>
                                            <?php } else { ?>
                                                <li class="list-group-item" style="margin-left:20px">
                                                    <a href="#submenu<?= $r->id; ?>" class="nav-link" data-toggle="collapse" aria-expanded="false" aria-controls="submenu<?= $r->id; ?>">
                                                 <?= $r->title ?>
                                                        <i class="fas fa-chevron-down float-right"></i>
                                                    </a>
                                                    <div class="collapse" id="submenu<?= $r->id; ?>">
                                                        <ul class="list-group">
                                                            <?php foreach($submenu as $men): ?>
                                                                <li class="list-group-item" style="margin-left:55px">
                                                                    <a href="<?= base_url($men->url . '/' . $men->id); ?>"><i class="fas fa-chevron-right "></i> <?= $men->title ?></a>
                                                                </li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </div>
                        ...
                        <?php } else { ?>
                            <li class="list-group-item">
                                <a href="<?= base_url($url); ?>"><i class="<?= $menu->icon_class; ?>"></i> <?= $menu->title; ?></a>
                            </li>
                        <?php } ?>
                    <?php endforeach; ?>
                </ul>

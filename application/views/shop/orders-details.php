                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Round Off </th>
                                                <th><?= $shop_currency; ?> <?php echo  bcdiv(($orderData[0]['round_off']), 1, 2); ?></th>
                                            </tr>
                                            <tr>
                                                <th style="font-size: 1.3rem">Total</th>
                                                <th style="font-size: 1.3rem"><?= $shop_currency; ?> <?php echo round_price(($orderData[0]['total_value']+$orderData[0]['delivery_charges']));  ?></th>
                                            </tr>
                                                ...
                                                <?php
                                                    ...
                                                    if($orderItems!==FALSE){
                                                        ...
                                                        foreach($orderItems as $items){
                                                            //echo $items['product_id'].'<br>';
                                                            //$rs = $this->order_items_model->get_value($items['product_id']);
                                                           
                                                            echo '<tr>';
                                                            echo '<td>'.$count.'</td>';
                                                            echo '<td><img src="'.$items['img'].'" style="width:100px; max-height:100px;">&nbsp;&nbsp;'.$items['product_name'].' <strong>('.str_pad($items['product_code'], 6, '0', STR_PAD_LEFT).')</strong><br>'?> 
                                                            <?php 

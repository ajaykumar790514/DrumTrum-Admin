            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 p-hide">
                        ...
                        <div class="col-lg-3 col-sm-6 col-md-6" id="vendor-div">
                            <div class="form-group">
                        ...
                        <div class="col-lg-3 col-sm-6 col-md-6" id="customer-div">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" style="width:100%;" name="business_id" id="CustomerId" disabled>
                                    ...
                                    <?php foreach ($customer as $value) { ?>
                                        <option value="<?php echo $value->id; ?>">
                                            <?php echo $value->fname . ' ' . $value->lname; ?>(<?php echo $value->vendor_code; ?>)
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6" style="margin-top: 33px;">
                            <div class="form-group">

    ...
    <div id="grid_table"  class="table-responsive table-wrap">
        <table width="100%">
            ...
            <?php $i = $total_dr = $total_cr = 0; if (@$rows) { 
                $opening = $this->ladger_m->party_opening_new($rows[0]->type,$rows[0]->order_id);
                ?>
            <tr class="">
            ...
            <tr class="">
                ...
                <td class=""><?=($value->type =='Pymt' or $value->type =='Sale' or $value->type=='Purchase Return' ) ? 'Cr' : 'Dr' ?> <?= $value->name ? $value->name : $value->title ?></td>

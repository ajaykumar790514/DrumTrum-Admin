                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group form-check">
                                                            <input type="checkbox" class="form-check-input" id="upi-create" name="upi-create" value="1">
                                                            <label class="form-check-label" for="upi-create">Is UPI Available?</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <label class="control-label ml-3">Account No.</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">IFSC</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">Bank Name</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">Branch Name</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">Dr./Cr.:</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                                    <select class="form-control" name="dr_cr">
                                                                    <option value="">-- Select --</option>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">Amount:</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-col-12">
                                                                    <label class="control-label ml-3">Remark:</label>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-md-3">
                                                        <div class="form-group form-check">
                                                            <input type="checkbox" class="form-check-input" id="upi-update" name="upi-update" value="1" <?php echo ($value->is_upi == '1') ? 'checked' : ''; ?>>
                                                            <label class="form-check-label" for="upi-update">Is UPI Available?</label>
                                                        </div>
                                                    </div>
                                                    </div>
...
$(document).ready(function() {
    // Handle change event for the 'upi-create' checkbox
    $('#upi-create').change(function() {
        if ($(this).is(':checked')) {
            console.log('Checkbox "upi-create" is checked');
        } else {
            console.log('Checkbox "upi-create" is unchecked');
        }
    });

    // Handle change event for the 'upi-update' checkbox
    $('#upi-update').change(function() {
                if ($(this).is(':checked')) {
                    console.log('Checkbox "upi-update" is checked');
                } else {
                    console.log('Checkbox "upi-update" is unchecked');
                }
            });
});

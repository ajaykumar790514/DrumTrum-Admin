    ...
    <div id="grid_table" class="table-responsive table-wrap">
        <table>
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Supplier Code</th>
            ...
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-center" id="status<?php echo $value->id; ?>">
                 ...
                 <button class="btn btn-success btn-sm" onclick="change_status(<?php echo $value->id;?>)">Active</button>
                 <?php } else {?>
                 <button class="btn btn-danger btn-sm" onclick="change_status(<?php echo $value->id;?>)">Inactive</button>
                <?php }?>
                 </td>
                <td class="jsgrid-cell jsgrid-align-center">
                    

                    <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Update Supplier ( <?=$value->fname.' '.$value->lname?> )" data-url="<?=$update_url?><?=$value->id?>" >

                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">Suppliers Data</h3>
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control form-control-sm" name="tb-search" id="tb-search" value="<?=$search?>" placeholder="Search Name / Mobile / Supplier Code / GSTIN...">
                                    </div>
                                    <div class="col-lg-4 mt-1 col-md-6">
                                <button class="float-right btn btn-sm btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Supplier" data-url="<?=$new_url?>" >Add Supplier</button>
                                    </div></div>
                            </div>

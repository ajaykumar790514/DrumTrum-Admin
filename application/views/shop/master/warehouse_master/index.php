                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-12 col-lg-6 col-sm-12">
                                <h3 class="card-title" id="test">WareHouse Master Data</h3>
                                <h6 class="card-subtitle"></h6>
                            </div>

                            <div class="float-left col-md-12 col-lg-6 col-sm-12">
                                <button class="float-right btn btn-sm btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add WareHouse" data-url="<?=$new_url?>" >Add WareHouse</button>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <button class="float-right btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add WareHouse" data-url="<?=$new_url?>" >Add WareHouse</button>
                            </div>

        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fname" value="<?= $value->fname; ?>" placeholder="Enter first name">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label required">Last Name:</label>
                    <input type="text" class="form-control" name="lname" value="<?= $value->lname; ?>" placeholder="Enter last name">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label required">Mobile:</label>
                    <input type="number" class="form-control" name="mobile" value="<?= $value->mobile; ?>" placeholder="Enter mobile number">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label">Email:</label>
                    <input type="email" class="form-control" name="email" value="<?= $value->email; ?>" placeholder="Enter email address">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="pincode" value="<?= $value->pincode; ?>" placeholder="Enter pincode">
                </div>
            </div>
            <div class="col-lg-4" >
                <div class="form-group">
            ...
            <div class="col-lg-4" >
             ...
             <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <textarea  class="form-control" name="address" placeholder="Enter address"><?= $value->address; ?></textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-4 d-none" id="b2b_a_mobile">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="alternate_mobile" value="<?= $value->alternate_mobile; ?>" placeholder="Enter alternate mobile number">
                </div>
            </div>
            ...
            <div class="col-lg-4 d-none"  id="b2b_code">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="vendor_code" value="<?= $value->vendor_code; ?>" placeholder="Enter customer code">
                </div>
            </div>
            ...
            <div class="col-lg-4 d-none"  id="b2b_gst">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gstin" value="<?= $value->gstin; ?>"  id="gstinInput" oninput="validateInput()" placeholder="Enter gstin number">
            ...
            <div class="col-lg-4 d-none"  id="b2b_limit">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="credit_limit" value="<?= $value->credit_limit; ?>" placeholder="Enter credit limit">
                </div>
            </div>
            ...
            <div class="col-lg-4 d-none"  id="b2b_aadhaar">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="aadhar_no" value="<?= $value->aadhar_no; ?>" id="aadhar_no" maxlength="12" placeholder="Enter aadhaar number">
                                </div>
                            </div>
                            <div class="col-6"></div>
            ...
            <div class="col-3 d-none"  id="b2b_amount">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="amount" value="<?=@$opening->amount?>" step="0.01" pattern="\d+(\.\d{1,2})?" placeholder="Enter amount">
                </div>
            </div>
            <div class="col-6 d-none" id="b2b_remark">
                <div class="form-group">
                    <label class="control-label">Remark:</label>
                    <input type="text" class="form-control" placeholder="Enter remark" name="remark" value="<?=@$opening->remark?>">
                </div>
            </div>

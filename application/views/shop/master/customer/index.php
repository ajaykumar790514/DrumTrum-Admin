                ...
                <div class="row">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-sm" name="tb-search" id="tb-search" value="<?=$search?>" placeholder="Search Name / Mobile / Customer Code / GSTIN...">
                                    ...
                                    <button class="float-right btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal-xl" data-whatever="Add Customer" data-url="<?=$new_url?>" >Add Customer</button>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <button class="float-right btn btn-sm btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Customer" data-url="<?=$new_url?>" >Add Customer</button>
                            </div>
...
$(document).on("submit", '.ajaxsubmit', function(event) {
    ...
    if ($this.hasClass("needs-validation")) {
        if (!$this.valid()) {
            $("#btnsubmit").prop('disabled', false); // Re-enable button if validation fails
            element.className = ''; // Reset loader if validation fails
            return false;
        }
    }
    ...
    $.ajax({
        ...
        complete: function() {
            // Re-enable the submit button and reset the loader after AJAX completes
            $("#btnsubmit").prop('disabled', false);
            element.className = ''; // Reset the loader
        }
    });
    return false;
});

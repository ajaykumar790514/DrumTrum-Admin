                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-10 col-lg-10 col-sm-12">
                                <h3 class="card-title" id="test">Purchase Return</h3>
                    ...
                    <div class="col-12">
                        <form action="<?=$tb_url?>" class="tb-filter" method="post">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 mt-3">
                                ...
                                <input type="button" class="btn-sm btn btn-primary text-white" id="add-purchase-return" value="Add Purchase Return" data-toggle="modal" data-target="#showModal" data-whatever="Add Purchase Return" data-url="<?=base_url()?>purchase_return/return"> 
                                </div>
                            </div>
                            </div>
                        </form>

        ...
        <table width="100%">
            ...
            ?>
                <tr class="jsgrid-filter-row">
                    ...
                    <td class="jsgrid-cell jsgrid-align-center">
                    <?php if($value->txn_type==2){ echo ($value->name) ? $value->name : $value->bank_name;}elseif($value->txn_type==8){ echo ($value->title) ? $value->title : $value->bank_name;}else{ echo ($value->name) ? $value->name : $value->bank_name;}; ?></td></td>
                    ...
                    <td class="jsgrid-cell jsgrid-align-center">
                        ...
                        <a href="<?php echo base_url('cash-register/delete/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash" style="color:red"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </table>

...
<form class="ajaxsubmit needs-validation add-form" action="<?= $action_url ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 d-none "  id="b2b_code">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="vendor_code" onchange="CheckCustomerCode()" id="customer_code" placeholder="Enter customer code">
                </div>
            </div>

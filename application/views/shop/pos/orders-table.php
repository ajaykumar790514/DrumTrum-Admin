...
<!--============================================================== -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                        <div class="form-group">
                                        <label for="example-date-input" class="control-label">Bill No./Reference No / Narration</label>
                                            <input class="form-control form-control-sm" type="text" value="<?php if(isset($_SESSION['order_table_filters']['orderid'])){ echo $_SESSION['order_table_filters']['orderid']; }?>" id="orderid" placeholder="Bill No./Reference No / Narration">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-2 col-md-6 col-sm-6"  style="margin-top:-26px">
                    ...
                    $("#table-responsive").jsGrid({
                        ...
                        fields: [
                            ...
                            itemTemplate: function(val) {
                                ...
                                // Determine the color and text based on the value
                                if (val == 4) {
                                    paymentStatus = 'DUE';
                                    colorClass = 'btn btn-warning btn-sm'; // Warning color for DUE
                                } else {
                                    paymentStatus = 'PAID';
                                    colorClass = 'btn btn-success btn-sm'; // Success color for PAID
                                }
                                
                                return $("<button>").addClass(colorClass).text(paymentStatus);
                            },
                            align: "center",
                            width: 120
                        },
                        {
                            ...
                            
                            {
                                ...
                                itemTemplate: function(val ) {
                                    return $("<p>")
                                    .append(
                                        $('<i class="mdi mdi-printer text-warning" style="font-size:30px;"></i>')
                                            .attr("onclick", "printPopUp(" + val.row_id + ")")
                                    )
                                },
                                align: "center",
                                width: 120
                            },
                            {
                                ...
                                title: "Actions",  
                                itemTemplate: function(val) {
                                    var $returnButton = $("<a class='btn btn-sm btn-warning'>")
                                        .attr({
                                            href: 'sale_return/' + val.sale_return + '/' + val.orderid,
                                            target: '_blank',
                                        })
                                        .text('Return');
                                    var $editButton = $("<br><a class='mt-2 btn btn-sm btn-danger'>")
                                        .attr({
                                            href: '<?=base_url();?>shop-pos/edit_pos/' + val.row_id, 
                                            target: '_blank',
                                        })
                                        .text('Edit POS'); 
                                    return $("<div>").append($returnButton).append(" ").append($editButton);
                                },
                                align: "center",
                                width:120 
                            }
                ...
                setTimeout(function() {
                    ...
                    $("#table-responsive table").removeClass('jsgrid-table table table-striped table-sm');
                    $("#table-responsive table").addClass('table-responsive table-wrap');
                }, 50);


    function returnSale(orderid) {
    Swal.fire({
        title: 'Are you sure?',
        text: 'You are about to return sale for this order. This action cannot be undone!',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            proceedWithreturnSale(orderid);
        }
    });
}


function proceedWithreturnSale(orderid) {
    if (id === 0) {
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'You cannot return sale for this order!'
        });
    } else {
        Swal.fire({

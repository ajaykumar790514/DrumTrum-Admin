...
function saveMultiPay()
{
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.res == 'success') {
                $.ajax({
                    url: "<?= base_url() ?>shop-pos/saveMultiPayOrder",
                    type: 'POST',
                    dataType: "json",
                    data: formData,
                    success: function(data) {
...
function payLatterBillPrint()
{
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.res == 'success') {
                $.ajax({
                    url: "<?= base_url() ?>shop-pos/save_payater_order",
                    type: 'POST',
                    dataType: "json",
                    data: formData,
                    success: function(data) {
...
function processUPIOrder(action, upiAccountId) {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.res == 'success') {
                $.ajax({
                    url: "<?= base_url() ?>shop-pos/save_upi_order",
                    type: 'POST',
                    dataType: "json",
                    data: formData,
                    success: function(data) {
        ...
        formData.push({name:  "discount_type2", value:discount_type2})        
            ...
            $.ajax({
                ...
                success:function(data) {
                    if (data.res=='success') {
                        $.ajax({
                            url: "<?= base_url() ?>shop-pos/save_card_order",
                            type: 'post',
                            dataType: "json",
                            data: formData,
                            success: function(data) {
        ...
        formData.push({name:  "discount_type2", value:discount_type2})        
            ...
            $.ajax({
                ...
                success:function(data) {
                    if (data.res=='success') {
                        $.ajax({
                            url: "<?= base_url() ?>shop-pos/holdbillBill",
                            type: 'post',
                            dataType: "json",
                            data: formData,
                            success: function(data) {
        ...
        success: function(response) {
            if (response.success) {
                ...
                items.forEach(function(item) {
                    ...
                    if (row.length === 0) {
                        ...
                        let ProductTable = `<tr class='jsgrid-filter-row' data-product_code='${item.product_code}'>
                            ...
                            <td class='jsgrid-cell jsgrid-align-center Stock' style='display:none;'>${item.qty}</td>
              ...
              // Initialize discount and tax values
                ...
                var SubTotal=Number(((CouponDiscount+total_value)-round_off)).toFixed(2);

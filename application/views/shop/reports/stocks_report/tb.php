...
<div class="row">
    <div class="col-md-9 text-left">
     ...
     <div class="col-md-3 text-right">
        ...
        <a href="<?= base_url('reports/stock_report/export_to_excel/'.$parent_id.'/'.$cat_id.'/'.$child_cat_id.'/'.$search); ?>" class="btn btn-primary btn-sm mb-3"><i class="fas fa-arrow-up"></i> Excel</a>
    </div>
</div>
...
<!--</div>-->
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control child_cat_id form-control-sm" style="width:100%;" name="cat_id" id="cat_id" value="<?=$cat_id?>" onchange="fetch_products_by_cat(this.value)">
                    <option value="">Select</option>
     ...
     <div class="col-md-9 mt-1 d-flex">
        <h5 class="text-themecolor">Total Value = <b>₹ <?=@round($low_stock_result->total_purchase,2); ?></b></h5>
         <h5 class="text-themecolor ml-4">Total Stock = <b><?=@round($low_stock_result->total_stock,2); ?></b></h5>
    </div>
</div>
    <div id="datatable">
       ...
       function fetch_sub_categories(parent_id)
   {
    $.ajax({
        ...
        success: function(data){
            ...
            {
                $.ajax({
                    url: "<?php  echo base_url('reports/stock_report/tb'); ?>",
                    method: "POST",
                    data: {
                        cat_id:cat_id,
                        parent_id:parent_id,
...
//     });
//    }
//    function fetch_sub_cat(parent_cat_id)
//    {
//     $.ajax({
//         url: "<?php echo base_url('reports/fetch_cat'); ?>",
//         method: "POST",

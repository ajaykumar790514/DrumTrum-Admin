...
<div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="tb-search" id="tb-search" value="<?php if(@$tb_search!='null') echo $tb_search;?>" placeholder="Search...">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2" style="margin-top: 17px;">
                            <div class="form-group">
                                ...
                                <?php if(!empty($to_date)) { ?>
                                <a href="<?= base_url("pos-sale-register/export_to_excel/{$from_date}/{$to_date}/{$customer_id}/{$parent_id}/{$parent_cat_id}/{$sub_cat_id}/{$product_id}/{$brand_id}/{$status_id}/{$tb_search}/{$per_page}"); ?>" class="btn mt-3 btn-primary btn-sm mb-3 "><i class="fas fa-arrow-up"></i></a>
                                <?php }?>
                            </div>
                        </div>
                        </div>

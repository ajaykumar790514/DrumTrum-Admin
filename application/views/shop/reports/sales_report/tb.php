    ...
    <div id="grid_table" class="table-responsive table-wrap">
        <table >
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center table-heading">Discount</th>
                <th class="jsgrid-header-cell jsgrid-align-center table-heading">Landing Price</th>
            ...
            <?php $i=$page;$Landing_price=$discount=$discount_per=0; foreach($sales_report as $value){ 
                ...
                <?php 
                   ...
                   {
                     $discount_per = ($value->mrp-$value->offer_applied);
                     $Landing_price =  ($value->mrp-$discount_per);
                   }elseif($value->discount_type==1)
                   {
                     $discount_per= ($value->mrp*$value->offer_applied)/100;
                     $Landing_price =  ($value->mrp-$discount_per);
                   }
                    if($value->discount_type==0)
                   {
                     $discount = ($value->offer_applied)." OFF";
                   }elseif($value->discount_type==1)
                   {
                     $discount= ($value->offer_applied)." %";
                   }
                    ?>
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-center"><?= $discount; ?> </td>
                <td class="jsgrid-cell jsgrid-align-center">₹ <?= round($Landing_price,2); ?></td>

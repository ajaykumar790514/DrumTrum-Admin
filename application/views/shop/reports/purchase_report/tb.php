    ...
    <div id="grid_table" class="table-responsive table-wrap">
        <table width="100%">
            ...
            <tr class="jsgrid-filter-row">
                ...
                <a href="javascript:void(0);" class="toggle-items" data-target="#<?= $itemId ?>"><i title="Explore" class="fa fa-info float-left ml-3 text-primary"></i></a>
                <?= date_format_func($value->purchase_order_date); ?>
                </td>
            ...
            <tr class="jsgrid-header-row" style="display:none;" id="<?= $itemId ?>"> <!-- Hide items by default -->
            <td colspan="10">
                <table width="100%">
                    <?php 
                    $asciiValue = ord('A');

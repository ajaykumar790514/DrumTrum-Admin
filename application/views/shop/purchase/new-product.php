...
<div class="row">
    <div class="col-12">
        <table id="propertyTable4" class="table table-bordered">
            <thead>
                <tr>
                    <th>S.No.</th>
                    <th>Property Name</th>
...
<div class="row">
        ...
        <div class="col-5">
            <div class="form-group">
                ...
                <select class="form-control" id="prop_value4" name="prop_value4" style="width:100%;display:none;">
...
function addPropertyEdit() {
    ...
    var prop_type = $('#prop_value4').val().split(',');
    var prop_typeID = prop_type[0];
    var prop_typeName = prop_type[1];

    // Check if the property already exists
    var exists = false;
    $('#propertyTable4 tbody tr').each(function() {
    ...
    var rowCount = $('#propertyTable4 tbody tr').length + 1;
    var newRow = '<tr>' +
        ...
        '</tr>';
    $('#propertyTable4 tbody').append(newRow);
    $('#valueinput').val('');
}
...
function filter_propsEdit() {
        ...
        if (type == 2 || type == 3) {
            ...
            $.ajax({
                ...
                success: function(data){
                    console.log(data);
                    $("select[name='prop_value4']").html(data);
                },
            });
        }else{
            $("select[name='prop_value4']").hide();
            $("#valueinput").show();
        }
    }

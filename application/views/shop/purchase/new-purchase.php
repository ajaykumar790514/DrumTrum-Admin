...
<?php 
	$attributes = array('id' => 'add_new_purchase','data-parsley-validate' => true,'class' => 'form-horizontal');
        ...
        <div class="card">
              <div class="card-header">
                ...
                <div class="d-flex flex-wrap">
                    <div class="float-left col-md-12 col-lg-6 col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                       ...
                       <div class="col-lg-12">
                        ...
                        <select name="supplier" id="supplier" class="form-control form-control-sm select2" required>
                            
                        </select>
                    </div>
                       </div>
                       <input type="hidden" class="supplier2" id="supplier2" name="supplier2">
                       <input type="hidden" class="supplierName" id="supplierName">
                    </div>
                    <div class="col-lg-3 col-sm-6 col-md-6">
                       <div class="row">
                        <div class="col-lg-12 ">
                        <label for="">Purchase Order Date <span class="text-danger">*</span></label>
                        <input type="date" class="form-control form-control-sm " name="purchase_order_date" id="purchase_order_date"  required max="<?php echo date('Y-m-d') ;?>">
                        </div>
                      </div>
                   </div>
                     <div class="col-lg-3 col-sm-6 col-md-6">
                     <div class="row">
                        ...
                        <input type="text" class="form-control form-control-sm" name="purchase_order_no" id="purchase_order_no" placeholder="Enter no"  required>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-md-6">
                    <div class="row">
                        ...
                        <input type="date" class="form-control form-control-sm" name="shipping_date" id="shipping_date"  max="<?php echo date('Y-m-d') ;?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6 mt-3">
                     <div class="row">
                        <div class="col-lg-12 ">
                            ...
                            <div class="col-lg-12 ">
                            <span id="gst">GSTIN: - </span>
                            </div>
                            <div class="col-lg-12 ">
                            <span id="address">Billing Address </span>
                            </div>
                            <div class="col-lg-12 ">
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6 mt-3">
                     <div class="row">
                        ...
                        <textarea name="shipping_note" id="shipping_note" class="form-control form-control-sm"  ></textarea>
                        </div>
                     </div>
                    </div>
                ...
                <div class="row">
                 <div class="col-md-12 overflow-hidden mt-4">
                    <div class="table-responsive table-wrap">
                     <table class=" rooms_tb" width="100%" id="product_table">
                      <thead>
                        <tr class="text-center" style="background-color:#dadada">
                        ...
                        class="text-danger">*</small></th>
                        <th style="width: 100px;text-align:center" class="ptax text-center">Tax</th>
                        <th style="width: 100px;" class="plcost">If Offer</th>
                        ...
                        <tr class="text-center rooms_row" data-purchase-item="template" data-row-id="1">
                        ...
                        <td class="psrno"><span id="itemIndex" data-item-index>1</span>
                         <input type="hidden" id="indexNo" class="indexNo" value="1" name="indexNo[]" ></td>
                        <td class="pitemcode">
                        <div class="p-0 text-right m--font-bolder form-group mb-0">
                        <input type="text" class="form-control form-control-sm" name="itemCode[]" id="itemCode" placeholder="ItemCode" required  data-placement="top"/>
                        </div>
                        </td>
                        <td align="center" class="pname productVarientId-container" style="width:200px">
                        <select class="form-control select2 productVarientId" id="productVarientId" name="productVarientId[]"
                        placeholder="Select Product" required>
                        </select>
                        <br>
                        <button type="button"  class="btn-sm mt-2 btn-danger text-white item_edit" title="Edit Product" id="edit_item" onclick="setitem()" ><i class="fa fa-edit"></i></button> <button  type="button" class="btn ml-2 btn-sm btn-primary" title="Duplicate Product" id="edit_item" onclick="duplicate()" ><i class="mdi mdi-content-duplicate"></i></button>
                        </td>
                        <td class="pqty">
                        <div class="p-0 text-right m--font-bolder form-group mb-0">
                        ...
                        placeholder="Qty" value="0" class="" data-placement="top" data-debitnoteqty="0" required/>
                       </div>
                       </div>
                       </td>
                       <td class="puom ">
                       ...
                       name="uom[]" id="uom" placeholder="UOM" class="" data-placement="top" required/>
                       </div>
                       </td>
                       <td class="pprice">
                       <div class="p-0 text-right m--font-bolder form-group mb-0">
                       <input type="text" class="form-control form-control-sm unitCost" name="unitCost[]" id="unitCost"  onkeydown="check(event,this)" value="0" required/>
                       </div>
                       </td>
                      <td class="ptax" style="width: 100px;text-align:center">
                      <div class="p-0">
                      <span class="m--font-info" style="font-size:10px;" data-item-tax-name=""  id="data-item-tax-name"></span>
                      <span data-item-cess-amount="" id="data-item-cess-amount"></span><br>
                      ...
                      <input type="hidden" name="mrpp[]" id="mrpp" />
                     ...
                     <td class="plcost">
                     <div class="p-0">
                    <span data-item-cess-amount="" id="data-item-offer-name"></span><br>
                       <span data-item-tax-amount=""
                      id="data-item-offer-amount" style="font-size:14px;"><?=$shop_details->currency;?>. 0</span>
                      <input type="hidden" name="offerCost[]" id="offerCost" />
                     </div>
                     </td>
                     <td class="plcost">
                     <input  type="text" class="form-control form-control-sm text-right"
                     name="landingCost[]" id="landingCost" readonly="readonly" value="0" required/>
                     </td>
                     <td class="plcost ">
                     <input  type="text" class="form-control form-control-sm text-right"
                     name="margin[]" id="margin" readonly="readonly"
                     value="0" required />
                     <input type="hidden" id="catMargin" class="catMargin">
                    </td>
                     <td class="ptotal">
                     <input  type="text" class="form-control form-control-sm text-right"
                     name="netAmount[]" required id="netAmount" onkeydown="check(event,this)" placeholder="Amout" data-item-amount=""  value="0" class=""  />
                     </td>
                     </tr>
                     </tbody>
                     <tfoot>
                     ...
                     <th class="text-center"><span class="m--font-boldest" id="product_qty_total">0</span>
                     </th>
                     <th></th><th></th>
                     <th class="text-right"><?=$shop_details->currency;?>. <span id="tax_total">0.00</span>
                     </th>
                     <th></th>
                     <th></th>
                     <th class="text-right "></th>
                     <th><span class="m--font-boldest float-right" id="product_sub_total"><?=$shop_details->currency;?>. 0.00</span></th>
                    </tr>
                    </tfoot>
                    </table>
                 </div>
             ...
             <div class="m-form__actions card-body-sm">
                <div class="row">
                   <div class="col-lg-8 col-md-8 col-sm-12">
                     ...
                     <textarea class="form-control form-control-sm" name="notes" placeholder="Enter Note" rows="2"></textarea>
                     </div>
                     </div>
                     </div>
                     </div>
                     ...
                     <div class="col-md-12 p-0">
                      <table class="table table-sm table-bordered text-right mb-0">
                        <tbody>
                         ...
                         <input type="number" id="flatDiscount" oninput="calculate_amount()" name="flatDiscount" onkeydown="check(event,this)"  class="form-control form-control-sm rounded-0 flatDiscount col-lg-3 col-sm-6 col-md-6 text-right" value="0"    >
                         ...
                         <tr>
                         <th>Gross Amount</th>
                         <td><h6 class="mb-0 gross_amount" id="gross_amount">0</h6>
                          <input type="hidden" name="GrossTotal" id="GrossTotal" class="GrossTotal"></td>
                         </tr>
                         <tr class="">
                         <th><h6 class="mb-0">Discount</h6></th>
                         <td><h6 class="mb-0" id="total_disc">0</h6>
                          <input type="hidden" name="FinalDiscount" id="FinalDiscount"></td>
                         </tr>
                         <tr>
                         <th><h6 class="mb-0">Taxable Amount</h6></th>
                         <td><h6 class="mb-0 AmountwithoutTax" id="taxable_amount">0</h6>
                        <input type="hidden" name="FinalTaxWithAmount" id="FinalTaxWithAmount"></td>
                         </tr>
                         <tr>
                         ...
                         <td><h6 class="mb-0 tax_amount" id="tax_amount">0</h6>
                           <input type="hidden" name="FinalTax" id="FinalTax"></td>
                         </tr>
                         <tr>
                         <th>
                         <a tabindex="-1" href="javascript:void(0);"
                          ...
                          id="roundoff_edit" data-content="" class="m-link text-primary m-link--info m-link--state">Roundoff</a>
                              ...
                              <td><h6 class="mb-0" id="round_off">0.0</h6></td>
                               ...
                               <td><h4 class="mb-0 net_amount" id="net_amount">0</h4>
                                  <input type="hidden" id="FinalTotal" name="FinalTotal">
                                  <input type="hidden" id="FinalTotalRound" class="FinalTotalRound">
                                  <input type="hidden" id="FinalQty" name="FinalQty"></td>
                                </tr>
...
<script>
    ...
    $('#add_new_purchase').parsley();
    $('#add_new_purchase').on('submit', function(event){
      $('#spinner-div').show();
        event.preventDefault();
        let formdata = new FormData(this);
        if ($('#add_new_purchase').parsley().isValid()) {
            $.ajax({
                method: 'POST',
                url: CI_ROOT + 'purchase/add-purchase',
                data: formdata,
                contentType: false,
                processData: false,
                dataType: 'json',
                    ...
                    language: {
                        noResults: function () {
                            if(INSERTPORDUCT == 1){
                                ...
                                var url1 = '<?=base_url('purchase/create-new-product-name/');?>' + searchValue;
                                return '<div class="m-demo-icon"> <button class="float-right btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Product" data-url="'+url1+'" ><i class="mdi mdi-plus"></i>Add Product</button></div>';	
                            }else{
                                return "";
                            }
...
//         var newRow = $('<tr>').html(rooms_row);
//         newRow.find('[data-item-index]').text(currentIndex);
//         newRow.find('[id="indexNo"]').val(currentIndex);
...
$(document).ready(function() {
    ...
    // $('body').on('change', '[name="itemCode[]"]', function(e) {
    ...
    $(document).on("submit", '.add_product', function(event) {
        ...
        $.ajax({
            ...
            success: function(response1) {
                ...
                if(response.res) {
                    console.log("Response Rows:", rowReferences);
                    ...
                    for (var i = 0; i < rowReferences.length; i++) {
                        ...
                        }else
                        {
                            ...
                            _row.find('#data-item-offer-amount').text('<?=$shop_details->currency;?>. 0 ');
                        }
        ...
        success: function(data){
            ...
            if (data.res == 'success') {
                ...
                var amountTaxValue = data.taxAmount;
                    ...
                    var button = $('  <button type="button"  class="btn-sm mt-2 btn-danger text-white item_edit" title="Edit Product" id="edit_item" data-product-id="' + data.id + '"  ><i class="fa fa-edit"></i></button><button  type="button" class="btn ml-2  btn-sm btn-primary" title="Duplicate Product" id="duplicate_item"  data-product-id="' + data.id + '"  ><i class="mdi mdi-content-duplicate"></i></button>');
...
$(document).on("submit", '.duplicate_product', function(event) {
    ...
    $this = $(this);
    debugger;
    if ($this.hasClass("needs-validation1")) {
        if (!$this.valid()) {
            return false;
        }
    }
                ...
                Quantity = product.qty;
                        if(product.discount_type=='1')
                        {
                            ...
                            if(selling_per=='0'){
                                ...
                                newRow.find('#data-item-offer-amount').text("<?=$shop_details->currency;?>. "+selling_per);
                            }else{
                        ...
                        }else
                        {
                            ...
                            newRow.find('#data-item-offer-amount').text('<?=$shop_details->currency;?>. 0 ');
                        }
                        margn=product.landing_cost-selling_rate;
                        margnper = (margn/selling_rate)*100;
                        var AmountwithoutTax = product.purchase_rate;
...
let vGST = (gnumber)=>{
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var purchaseOrderDateInput = document.getElementById('purchase_order_date');
        var shippingDateInput = document.getElementById('shipping_date');

        purchaseOrderDateInput.addEventListener('change', function() {
        ...
        form.addEventListener('submit', function(event) {
            if (!validateShippingDate()) {
                event.preventDefault(); 
                toastr.error('Please ensure that the shipping date is not earlier than the purchase order date.');
            }
        });

        function validateShippingDate() {
            var purchaseOrderDate = new Date(purchaseOrderDateInput.value);
            var shippingDate = new Date(shippingDateInput.value);

            if (shippingDate < purchaseOrderDate) {
                shippingDateInput.setCustomValidity('Shipping date cannot be earlier than the purchase order date.');
        ...
        function setMinShippingDate() {
            var purchaseOrderDate = new Date(purchaseOrderDateInput.value);
            var minShippingDate = new Date(purchaseOrderDate.getTime() + 24 * 60 * 60 * 1000);
            shippingDateInput.min = minShippingDate.toISOString().split('T')[0];
        }
    });
</script>

                                    ...
                                    <table class="table">
                                        <thead>
                                          <tr>
                                                ...
                                                <td style="border-top: none !important; padding: .75rem; vertical-align: bottom; border-bottom: 1px solid #dee2e6;"><?php echo uk_date($orderData[0]['purchase_order_date']); ?><?php //echo uk_time($orderData[0]['added']); ?> <br> <?php //echo $orderData[0]['datetime']; ?></td>
                                            </tr>    
                                            <tr>
                                                <th>Total items</th>

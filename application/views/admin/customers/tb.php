...
<div class="row">
    ...
    <div class="col-md-6 text-right">
        ...
        <div class="col-md-8" style="float: left; margin: 12px 0px;">
            <a class="btn btn-sm btn-primary " data-toggle="modal" href="#" data-target="#send-notification" >Send Notification</a>
        </div>
...
<div class="row">
        ...
        <div class="col-lg-3 col-sm-6 col-md-6">
            ...
            <input type="date" class="form-control form-control-sm" name="to_date" id="to_date" value="<?=$to_date?>" onchange="filter_customers(this.value)">
        ...
        <div class="col-lg-3 col-sm-6 col-md-6" style="margin-top:33px">
            <div class="form-group">

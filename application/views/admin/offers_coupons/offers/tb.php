    ...
    <div id="grid_table" class="table-responsive table-wrap">
        ...
        <?php } ?>  
                ...
                <td class="jsgrid-cell jsgrid-align-center" id="status<?php echo $value->id; ?>">
                                                        ...
                                                        <?php } else {?>
                                                            <button class="btn bnt-sm btn-danger" onclick="change_status(<?php echo $value->id;?>)">Inactive</button>
                                                            <?php }?>
                                                        </td>
                <td class="jsgrid-cell jsgrid-align-center">
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('offers-coupons/change_offer_coupon_status/'); ?>"+id,
        method: "POST",
        data: {
            id:id
        },

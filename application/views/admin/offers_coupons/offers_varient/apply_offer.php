    ...
    <div class="col-lg-12 col-md-12">
       ...
       <div class="row d-none apllyofferstab">
        <div class="col-lg-6 col-sm-6 col-md-6">
                ...
                <input type="search" class="form-control form-control-sm" id="prod-search" placeholder="Search" aria-controls="DataTables_Table_0" >
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6">
            <a data-toggle="modal" class="float-right btn-sm btn btn-primary" style="margin-top: 33px;margin-left:-2rem" href="#" data-target="#apply-category1" onclick="available_offers_all_var()">Apply on All Varients</a >
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6">
            <a class="float-right btn btn-sm btn-primary text-white" style="margin-top: 33px;margin-left:-2rem"  onclick="remove_all_var()">Remove All Varients</a >
            </div>
        </div>
        </div>
        <!--Add property modal-->

...
<script type="text/javascript">
   function available_offers(pid)
   {
    ...
    $.ajax({
        url: "<?php echo base_url('offers-coupons/available_all_offers'); ?>",
        method: "POST",
        data: {
            pid:pid,shop_id:shop_id,prod_id:prod_id
        },
...
<script type="text/javascript">
   ...
   function remove_all_var()
   {
    ...
    if(confirm('Are you sure?') == true)
    {
        ...
        var shop_id = $('#shop_id').val();
    $.ajax({
        url: "<?php echo base_url('offers-coupons/remove_all_var'); ?>",
        method: "POST",
        data: {
            prod_id:prod_id,shop_id:shop_id
        },

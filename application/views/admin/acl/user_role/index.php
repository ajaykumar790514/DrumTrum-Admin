                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">User Role</h3>
                                <h6 class="card-subtitle"></h6>
                            </div>

                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <button class="float-right btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add New User Role" data-url="<?=$new_url?>" >Add New User Role</button>
                            </div>
...
var timer;
        ...
        function _delete(e){
            var warning_msg = 'You want to delete ?';
            var attr = $(e).attr("warning-msg");
            if (typeof attr !== typeof undefined && attr !== false) {
                var warning_msg = attr;
            }
            Swal.fire({
            toast:true,
            type: 'warning',

                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">Business Data</h3>
                                <h6 class="card-subtitle"></h6>
                            </div>

                            <!-- <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <button class="float-right btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Business" data-url="<?=$new_url?>" >Add Business</button>
                            </div> -->
        ...
        $(document).on('keyup', '#tb-search', function(event){
            if(event.keyCode == 13)
            {
                ...
                timer = setTimeout(function(){
                    ...
                    // console.log(search);
                    var tbUrl = $('[name="tb"]').val();
                    $.post(tbUrl,{state_id:state_id,city_id:city_id,search:search})
                    .done(function(data){
                        $('#tb').html(data);
                        if($('#tb-search').val()!== '')
                        {

            ...
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-left">
                    <?php $addr = strip_tags( $value->address);
                        ...
                        .... <button class="btn btn-sm btn-primary btn-xs" data-toggle="modal" data-target="#read-address<?php echo $value->id; ?>">Read More</button>
                    <?php } ?>
                </td>
                ...
                .... <button class="btn btn-sm btn-primary btn-xs" data-toggle="modal" data-target="#read-desc<?php echo $value->id; ?>">Read More</button>
                <?php } ?>
                </td>
...
<script>
    function delete_shop(shopid){
        ...
        {
            $.ajax({
                url: "<?php echo base_url('business-store/shops/delete_shop/'); ?>"+shopid,
                method: "POST",
                data: {
                    shopid:shopid
                },
   ...
   function change_status(id)
    {
        ...
        {
            $.ajax({
                url: "<?php echo base_url('master-data/change_shop_status/'); ?>"+id,
                method: "POST",
                data: {
                    id:id
                },

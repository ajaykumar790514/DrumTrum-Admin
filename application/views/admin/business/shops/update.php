...
<div class="modal-body">
        ...
        <div class="col-6">
            ...
            <div class="col-6">
                ...
                <img src="<?php echo IMGS_URL.$value->signature;?>" alt="<?php echo $value->shop_name; ?>" height="50">
                <?php } ?>
            </div>
            <div class="col-12 mt-3">
                <div class="form-group">
                    <label class="control-label">Bill Size:</label>
                    <select class="form-control" name="bill_size">
                      <option value="">--Select Bill Size--</option>
                      <option value="A4" <?php if($value->bill_size=='A4'){ echo "selected";};?> >A4 Size</option>
                      <option value="LP" <?php if($value->bill_size=='LP'){ echo "selected";};?> >Lavel Printer Size</option>
                    </select>
                </div>
            </div>
            <div class="col-12">

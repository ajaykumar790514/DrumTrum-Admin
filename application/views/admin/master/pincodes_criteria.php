                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="float-right col-md-6 col-lg-6 col-sm-12">
                                                <div id="add-pincode-criteria" class="modal  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm col-lg-6 float-left" placeholder="Search...." id="search-pincode">
                                                    <button class="float-right btn btn-sm btn-primary" data-toggle="modal" data-target="#add-pincode-criteria" >Add Pincode Criteria</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

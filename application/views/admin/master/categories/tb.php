...
<div class="row">
        ...
        <div class="col-lg-3 col-sm-6 col-md-6">
            ...
            <select class="form-control form-control-sm parent_cat_id" style="width:100%;" name="parent_cat_id" id="parent_cat_id" onchange="fetch_results(this.value)">
            <?php if(!empty($cat_id)) { ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- <form action="" method="post" class="row">
                    ...
                    <div class="col-9">
                        <div class="form-group">
                            <select name="prop_master" class="form-control form-control-sm">

                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" style="width:100%;" name="business" id="business_id" onchange="fetch_shop(this.value)">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm shop_id" style="width:100%;" name="shop" id="shop_id">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" style="width:100%;" name="banner_type" id="banner_type" required>
                                    ...
                                    <div class="col-lg-2 col-md-6 col-sm-6 " style="margin-top:33px">
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-sm btn-danger waves-light" type="submit" value="Search">
                                        </div>
                                    </div>
                                </div>
                            </form>
                                                    ...
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="file" class="form-control" id="bannerImage1" name="img" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input id="btnsubmit1" class="btn btn-danger waves-light" type="submit" value="ADD">
                                                            </div>
                                                ...
                                                <div id="edit-home-banner<?php echo $value->id; ?>" class="modal  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            <label for="recipient-name" class="control-label">Image</label>
                                                                            <input type="file" class="form-control" id="bannerImage" name="img">
                                                                        </div>
                                                                        <?php if(!empty($value->img)){?>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                                                                <input id="btnsubmit" class="btn btn-danger waves-light" type="submit" value="UPDATE">
                                                            </div>
                                                            </form>
...
<script type="text/javascript">
    // Function to check file size
      function checkFileSize() {
        ...
        var maxSize = 500 * 1024; // 100 KB
        var submitButton = $('#btnsubmit');
        
        for (var i = 0; i < files.length; i++) {
            if (files[i].size > maxSize) {
                toastr.error("Banner image should be less than 500 KB.");
    ...
    $('#bannerImage').on('change', checkFileSize);
    function checkFileSize1() {
        var files = $('#bannerImage1')[0].files;
        var maxSize = 500 * 1024; // 100 KB
        var submitButton = $('#btnsubmit1');
    ...
    // Bind file size check to the file input field
    $('#bannerImage1').on('change', checkFileSize1);

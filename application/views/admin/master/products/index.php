                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-2 col-sm-6">
                                <h3 class="card-title" id="test">Product Data</h3>
                                <h6 class="card-subtitle"></h6>
                            </div>
                            <div class="col-md-6 col-lg-2 col-sm-6">
                                <button class="btn btn-sm btn-primary" onclick="enable_cat_pro()">Enable Product</button>
                            </div>
                            <div class="col-md-6 col-lg-2 col-sm-6">
                                <button class="btn btn-sm btn-primary" onclick="disable_cat_pro()">Disable Product</button>
                            </div>
                            <div class="col-md-6 col-lg-2 col-sm-6">
                                <button class="btn btn-sm btn-primary" onclick="apply_cat_multibuy()">Apply Multibuy</button>
                            </div>
                            <div class="col-md-6 col-lg-2 col-sm-6">
                                <button class="btn btn-sm btn-primary" onclick="remove_cat_multibuy()">Remove Multibuy</button>
                            </div>
                            <div class="col-md-6 col-lg-2 col-sm-6">
                                <button class="float-right btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Product" data-url="<?=$new_url?>" >Add Product</button>
                            </div>
        ...
        $(document).on('input','.change-indexing',function (event) {
            ...
            timer = setTimeout(function() {
                ...
                var value = t.val();
                 ...
                 .done(function() {
                    alert_toastr("success","Set Product Sequence Successfully.");
                 })
                .fail(function() {

                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">Return Policy Master Data</h3>
                                <h6 class="card-subtitle"></h6>
                            </div>

                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                            <!-- <button class="float-right btn btn-primary ml-3" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Remove Return Policy" data-url="<?//=$remove_url?>" >Remove Return Policy</button> -->
                                <button class="float-right btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Return Policy" data-url="<?=$new_url?>" >Add Return Policy</button>
                            </div>
